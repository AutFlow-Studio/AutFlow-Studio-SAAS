  ...
  await db.insert(tasksTable).values([
    {
      ...
      priority: "high",
      status: "todo",
      description: "Go to Clients → New Client and fill in the company name, contact, and billing details.",
    },
    {
      workspaceId: wid,
      ...
      priority: "high",
      status: "todo",
      description: "Go to Projects → New Project, link it to a client, and set a budget and deadline.",
    },
    {
      workspaceId: wid,
      ...
      priority: "medium",
      status: "todo",
      description: "Go to Settings and update your agency name, logo, invoice prefix, and payment terms.",
    },
    {
      workspaceId: wid,
      ...
      priority: "medium",
      status: "todo",
      description: "Go to Payments → New Invoice, select a client and project, and set the amount and due date.",
    },
    {
      workspaceId: wid,
      ...
      priority: "low",
      status: "todo",
      description: "Go to Meetings → New Meeting to record notes, action items, and next meeting date.",
    },
  ]);
}
  ...
  await db.insert(tasksTable).values([
    {
      ...
      priority: "high",
      status: "todo",
      description: "Go to Clients → New Client. Record the company, key decision-maker, contract value, and payment method.",
    },
    {
      workspaceId: wid,
      ...
      priority: "high",
      status: "todo",
      description: "Go to Projects → New Project. Define the engagement scope, deliverables, and timeline.",
    },
    {
      workspaceId: wid,
      ...
      priority: "medium",
      status: "todo",
      description: "Go to Meetings → New Meeting to capture session notes, decisions, and action items.",
    },
    {
      workspaceId: wid,
      ...
      priority: "medium",
      status: "todo",
      description: "Go to Payments → New Invoice. Track retainer or project-based billing.",
    },
    {
      workspaceId: wid,
      ...
      priority: "low",
      status: "todo",
      description: "Go to Settings to update your firm name, logo, currency, and payment terms.",
    },
  ]);
}
  ...
  await db.insert(tasksTable).values([
    {
      ...
      priority: "high",
      status: "todo",
      description: "Go to Clients & Patients → New Client. Record the organisation name, clinical contact, and billing info.",
    },
    {
      workspaceId: wid,
      ...
      priority: "high",
      status: "todo",
      description: "Go to Care Programs → New Program. Define the program type, session count, timeline, and billing.",
    },
    {
      workspaceId: wid,
      ...
      priority: "medium",
      status: "todo",
      description: "Go to Meetings → New Meeting to record session notes, care decisions, and the next appointment date.",
    },
    {
      workspaceId: wid,
      ...
      priority: "medium",
      status: "todo",
      description: "Go to Payments → New Invoice to track session fees or program billing.",
    },
    {
      workspaceId: wid,
      ...
      priority: "low",
      status: "todo",
      description: "Go to Settings to update your practice name, currency, and invoice prefix.",
    },
  ]);
}
  ...
  await db.insert(tasksTable).values([
    {
      ...
      priority: "high",
      status: "todo",
      description: "Go to Clients → New Client. Add the contact name, email, and preferred payment method.",
    },
    {
      workspaceId: wid,
      title: "Create your first project",
      priority: "high",
      status: "todo",
      description: "Go to Projects → New Project. Set the scope, rate, deliverables, and deadline.",
    },
    {
      workspaceId: wid,
      ...
      priority: "high",
      status: "todo",
      description: "Go to Payments → New Invoice. Many freelancers bill 50% upfront — record that here.",
    },
    {
      workspaceId: wid,
      ...
      priority: "medium",
      status: "todo",
      description: "Go to Tasks → New Task to break the project into actionable steps with deadlines.",
    },
    {
      workspaceId: wid,
      ...
      priority: "low",
      status: "todo",
      description: "Go to Settings to set your name, invoice prefix, payment terms, and tax rate.",
    },
  ]);
}
  ...
  await db.insert(tasksTable).values([
    {
      ...
      priority: "high",
      status: "todo",
      description: "Go to Clients → New Client and fill in the company details, primary contact, and billing info.",
    },
    {
      workspaceId: wid,
      title: "Create your first project",
      priority: "high",
      status: "todo",
      description: "Go to Projects → New Project. Link it to a client, set a budget and deadline.",
    },
    {
      workspaceId: wid,
      title: "Issue your first invoice",
      priority: "medium",
      status: "todo",
      description: "Go to Payments → New Invoice to track what you're owed.",
    },
    {
      workspaceId: wid,
      ...
      priority: "low",
      status: "todo",
      description: "Use Tasks to manage your to-do list and Meetings to log client session notes.",
    },
    {
      workspaceId: wid,
      ...
      priority: "low",
      status: "todo",
      description: "Go to Settings to update your business name, currency, and invoice preferences.",
    },
  ]);
}
