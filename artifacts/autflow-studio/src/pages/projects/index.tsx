import { useListProjects, useCreateProject, useListClients, getListProjectsQueryKey, getGetDashboardQueryKey } from "@workspace/api-client-react";
...
export default function ProjectsList() {
  ...
  const { data: allProjects, isLoading, isError } = useListProjects({ search: search || undefined });
  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <PageError message="Failed to load projects." />
