import { useListPayments, useCreatePayment, useListClients, getListPaymentsQueryKey, getGetDashboardQueryKey } from "@workspace/api-client-react";
  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <PageError message="Failed to load invoices." />
