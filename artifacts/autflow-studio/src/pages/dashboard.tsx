...
// ---------------------------------------------------------------------------
// Clear Data dialog
// Shown to users with the "owner" role. Requires the user to type a
// confirmation phrase before the destructive action is submitted. Includes an
// optional "Export All Data" step so owners can download a CSV backup first.
// The backend also validates the phrase and the owner role independently.
// ---------------------------------------------------------------------------
...
export default function Dashboard() {
  ...
  // Clear Data is surfaced only to users with the "owner" role.
